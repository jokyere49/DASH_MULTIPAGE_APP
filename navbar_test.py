...
nav_item_signin = dbc.NavItem(dbc.NavLink("Sign in ", href="#", style={'color': 'white'}))
nav_item_register = dbc.NavItem(dbc.NavLink("Register ", href="#", style={'color': 'white'}))
nav_item_signout = dbc.NavItem(dbc.NavLink("Sign out ", href="#", style={ 'color': 'white'}))

jeff_navbar = dbc.Navbar(
    dbc.Container(
        [
            dbc.NavbarBrand("Scienceylab", href="#", style={'font-family': 'Cursive', 'color': 'white'}),
            dbc.NavbarToggler(id="navbar-toggler4"),
            dbc.Collapse(
                dbc.Nav(
                    [nav_item_signin, nav_item_register, nav_item_signout], 
...
app.layout = html.Div(
    [default, custom_default, logo, search_navbar, dashboard, jeff_navbar]
)
